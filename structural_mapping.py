...
from structural.automated_block_mapping import automatically_map_blocks, print_mapped_blocks
...
def structurally_map_netlists(golden_netlist_arg, reversed_netlist_arg):
    ...
    # print_conformal_input_output_points(ir1.top_instance, ir1.top_instance.reference.name, ir2.top_instance.reference.name)
